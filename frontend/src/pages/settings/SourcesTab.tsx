          ...
          {settings.google_news_rss_enabled && (
            <>
              <div className="form-section">
                <h3 className="form-section-heading">{t("sources.googleNewsRss.sections.region")}</h3>
              ...
              <div className="form-section">
                <h3 className="form-section-heading">{t("sources.googleNewsRss.sections.sources")}</h3>
                <label>
              ...
              <div className="form-section">
                <h3 className="form-section-heading">{t("sources.googleNewsRss.sections.behavior")}</h3>
                <label className="checkbox-label">
                  <input
                    type="checkbox"
